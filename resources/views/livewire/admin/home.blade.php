                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col mt-0">
                                                <h5 class="card-title">
                                                    {{ $lang->data['lifetime_orders'] ?? 'Lifetime Orders' }}</h5>
                                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col mt-0">
                                                <h5 class="card-title">{{ $lang->data['today_order'] ?? 'Today Order' }}
                                                </h5>
                                            </div>
                                        ...
                                        <h1 class="mt-1 mb-3">
                                            {{ \App\Models\Order::whereDate('date', \Carbon\Carbon::today())->count() }}
                                        </h1>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col mt-0">
                                                <h5 class="card-title">{{ $lang->data['today_sale'] ?? 'Today Sale' }}
                                                </h5>
                                            </div>
                                        ...
                                        <h1 class="mt-1 mb-3">
                                            {{ getCurrency() }}{{ \App\Models\Order::whereDate('date', \Carbon\Carbon::today())->sum('total') }}
                                        </h1>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col mt-0">
                                                <h5 class="card-title">
                                                    {{ $lang->data['total_customer'] ?? 'Total Customer' }}</h5>
                                            </div>
